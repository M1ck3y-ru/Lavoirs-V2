...
Prototype de "V2" inspiré de [lavoirs.org](https://www.lavoirs.org/) : géolocalisation temps réel, lavoirs à proximité sur une carte, itinéraire à pied vers le lavoir choisi.
...
- [OSRM](https://project-osrm.org/) (serveur de démo public, profil piéton) pour l'itinéraire
